...
//    scene.load_environment_map("./car/environment_dusk.hdr");
    scene.load_environment_map("./diningroom/environment.hdr");
    ...
    renderer.setup_window(1920/1,1080/1);
//    renderer.setup_window(600,600);
    ...
    frame.save_image("C:/Users/wyz/projects/RayTracer/result/dinningroom_result_4.jpg");
